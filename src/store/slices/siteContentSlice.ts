  ...
  whyChooseUs: [
    {
      id: "why-1",
      icon: "certified",
      title: "Certified 100% Purity",
      subtitle: "Every diamond and gold piece is hallmarked and certified.",
    },
    {
      id: "why-2",
      icon: "care",
      title: "Lifetime Warranty",
      subtitle: "Complimentary cleaning, polishing, and stone inspection.",
    },
    {
      id: "why-3",
      icon: "shipping",
      title: "Insured Free Delivery",
      subtitle: "Tamper-evident luxury packaging delivered safely to your door.",
    },
    {
      id: "why-4",
      icon: "returns",
      title: "30-Day Easy Exchange",
      subtitle: "Guaranteed buyback and hassle-free returns on all orders.",
    },
  ],
  serviceStrip: [
    {
