      ...
      <div className="w-full max-w-lg bg-[#161412] border border-gold/25 rounded-2xl shadow-2xl overflow-hidden relative z-10 p-6 sm:p-10 lg:p-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-1">
            <label className="flex items-start gap-2 cursor-pointer group">
              ...
              />
              <span className="text-caption text-cream/70 group-hover:text-cream transition-colors leading-relaxed">
                I agree to the{" "}
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 text-cream text-caption font-medium transition-colors cursor-pointer"
          >
