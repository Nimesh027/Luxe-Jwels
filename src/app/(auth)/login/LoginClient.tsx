  ...
  return (
    <div className="min-h-[calc(100vh-0px)] bg-[#0f0e0d] text-cream flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg bg-[#161412] border border-gold/25 rounded-2xl shadow-2xl overflow-hidden relative z-10 p-6 sm:p-10 lg:p-12">
        ...
        {forgotNotice && (
          <div className="mb-6 p-3.5 rounded-xl bg-gold/10 border border-gold/30 text-xs text-gold flex items-center justify-between animate-in fade-in slide-in-from-top-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between pt-1">
            <label className="flex items-center gap-2 cursor-pointer group">
              ...
              />
              <span className="text-xs text-cream/70 group-hover:text-cream transition-colors">
                Keep me signed in
              </span>
            </label>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 text-cream text-xs font-medium transition-colors cursor-pointer"
          >
