  ...
  return (
    <Section>
      ...
      >
        ...
        <span>/</span>
        <span className="font-semibold text-wine">Returns & Exchange Policy</span>
      </nav>

      {/* MAIN PAGE TITLE */}
      <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
        <h1 className="font-display text-3xl sm:text-4xl text-wine font-semibold tracking-wide">
          Returns & Lifetime Exchange Policy
        </h1>
        <p className="text-xs sm:text-sm text-muted font-light leading-relaxed">
          We want you to love your heirloom creation. Luxe Jewels offers a 15-day 100% money-back guarantee and a transparent Lifetime Exchange Policy for all fine jewellery.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
        <div className="bg-surface rounded-2xl border border-border/80 p-6 text-center space-y-3 shadow-2xs hover:border-wine/30 transition-all">
          ...
          <h3 className="font-display font-semibold text-wine text-base">15-Day Money Back</h3>
          <p className="text-xs text-muted leading-relaxed">Full 100% refund with zero deductions on returns initiated within 15 days.</p>
        </div>
        ...
        <div className="bg-surface rounded-2xl border border-border/80 p-6 text-center space-y-3 shadow-2xs hover:border-wine/30 transition-all">
          ...
          <h3 className="font-display font-semibold text-wine text-base">Lifetime Exchange</h3>
          <p className="text-xs text-muted leading-relaxed">Upgrade or exchange your jewellery anytime at prevailing gold & diamond market rates.</p>
        </div>
        ...
        <div className="bg-surface rounded-2xl border border-border/80 p-6 text-center space-y-3 shadow-2xs hover:border-wine/30 transition-all">
          ...
          <h3 className="font-display font-semibold text-wine text-base">Free Reverse Pickup</h3>
          <p className="text-xs text-muted leading-relaxed">Complimentary white-glove, insured courier pickup directly from your doorstep.</p>
        </div>
        ...
        <div className="bg-surface rounded-2xl border border-border/80 p-6 text-center space-y-3 shadow-2xs hover:border-wine/30 transition-all">
          ...
          <h3 className="font-display font-semibold text-wine text-base">Instant Refunds</h3>
          <p className="text-xs text-muted leading-relaxed">Refunds processed to original payment method within 2-4 days post quality audit.</p>
        </div>
      </div>
        ...
        <div className="pt-8 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            <div className="bg-[#FAF0F2]/60 rounded-xl p-4 border border-wine/10">
              <span className="w-7 h-7 rounded-full bg-wine text-white text-xs font-bold flex items-center justify-center mb-2">1</span>
              <h4 className="font-semibold text-wine text-xs sm:text-sm">Initiate Return</h4>
            ...
            <div className="bg-[#FAF0F2]/60 rounded-xl p-4 border border-wine/10">
              <span className="w-7 h-7 rounded-full bg-wine text-white text-xs font-bold flex items-center justify-center mb-2">2</span>
              <h4 className="font-semibold text-wine text-xs sm:text-sm">Insured Doorstep Pickup</h4>
            ...
            <div className="bg-[#FAF0F2]/60 rounded-xl p-4 border border-wine/10">
              <span className="w-7 h-7 rounded-full bg-wine text-white text-xs font-bold flex items-center justify-center mb-2">3</span>
              <h4 className="font-semibold text-wine text-xs sm:text-sm">Audit & Fast Refund</h4>
