...
export function HeartIcon({ size = 20, className = "", filled = false, ...props }: IconProps) {
  if (filled) {
    return (
      <svg
        width={size}
...
// 10. SHIELD / SECURITY / BIS HALLMARK ICON
...
// 11. TRUCK / DELIVERY TRACKER ICON
...
// 12. GIFT ICON
export function GiftIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 14. DIAMOND / SPARKLES ICON
export function DiamondIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 19. CLOCK / HISTORY ICON
export function HistoryIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 21. STAR / RATING ICON
export function StarIcon({ size = 16, className = "", filled = true, ...props }: IconProps) {
  if (filled) {
    return (
      <svg
        width={size}
...
// 23. CROWN ICON (Luxury / Royal / General)
export function CrownIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 24. GOLD BAR / METAL ICON
export function GoldBarIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <polygon points="5 6 19 6 22 18 2 18" />
      <line x1="8" y1="12" x2="16" y2="12" />
    </svg>
  );
}

// 25. BOOK OPEN / DESCRIPTION ICON
...
// 26. THUNDERBOLT / LIGHTNING ICON (EMI / Offers)
export function ThunderboltIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 27. SAFETY CERTIFICATE / HALLMARK BADGE ICON
export function SafetyCertificateIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 32. SMARTPHONE ICON
export function SmartphoneIcon({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 34. RECYCLE ICON
export function RecycleIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M11 19h8.2a1.8 1.8 0 0 0 1.55-.86c.4-.65.4-1.47 0-2.12l-2.7-4.65" />
      <path d="M7.8 7.5l2.4-4.14a1.8 1.8 0 0 1 3.1 0l1.7 2.94" />
      <polyline points="2 15 5 19 8 15" />
      <polyline points="22 11 19 7 16 11" />
    </svg>
  );
}
...
// 38. MEDAL ICON
export function MedalIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M14.5 9 12 2 9.5 9" />
    </svg>
  );
}

// 39. MESSAGE SQUARE / ASSISTANCE / SUPPORT ICON
...
// 40. PACKAGE / BOX ICON
export function PackageIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 41. FILE TEXT / ORDER RECEIPT ICON
...
// 42. BANK / NETBANKING ICON
export function BankIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
