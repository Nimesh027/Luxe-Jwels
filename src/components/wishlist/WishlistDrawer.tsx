              ...
              {items.map((product) => (
                <div key={product.id} className="py-4.5 flex gap-4">
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    <div>
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="text-neutral-400 hover:text-wine transition-colors p-0.5 cursor-pointer shrink-0"
                        >
                          <svg className="h-4 w-4 fill-wine text-wine" viewBox="0 0 24 24">
                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                          </svg>
                        </button>
                      </div>
                    ...
                    {/* Quick Move to Cart & Remove Link */}
                    <div className="mt-3 flex items-center justify-between gap-2">
                      <button
                        ...
                        className="h-8 rounded-lg bg-ink px-3 text-[11px] font-semibold uppercase tracking-wider text-cream shadow-xs transition-all hover:bg-wine hover:shadow-md cursor-pointer"
                      >
                        Add To Cart
                      </button>
                      ...
                      <button
                        type="button"
                        onClick={() => toggle(product)}
                        className="text-[11px] text-muted hover:text-wine flex items-center gap-1 transition-colors cursor-pointer"
                      >
                        <span>♡</span>
                        <span>Remove</span>
                      </button>
